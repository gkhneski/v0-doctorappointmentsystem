...
INSERT INTO public.doctors (name, specialization, email, phone) VALUES
  ('Prof. Dr. Eray Çalışkan', 'Kadın Hastalıkları ve Doğum Uzmanı', 'geski@live.de', '0555 123 4567')
ON CONFLICT (email) DO NOTHING;

-- Insert schedules for weekdays (Monday-Friday) 09:00-18:00
...
CROSS JOIN generate_series(1, 5) AS dow  -- 1-5: Pazartesi-Cuma
