...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Allow admin read infertility_evaluations" ON infertility_evaluations;
  DROP POLICY IF EXISTS "Allow admin insert infertility_evaluations" ON infertility_evaluations;
  DROP POLICY IF EXISTS "Allow admin update infertility_evaluations" ON infertility_evaluations;
END $$;
