...
import { Calendar, Users, UserCog, PlusCircle, LayoutDashboard, Menu, MessageSquare, Pill } from "lucide-react"
import { cn } from "@/lib/utils"
import { useState } from "react"
import { Button } from "@/components/ui/button"

const navigation = [
  { name: "Dashboard", href: "/admin", icon: LayoutDashboard, roles: ["doktor", "sekreter", "hemsire"] },
  {
  ...
  { name: "Randevular", href: "/admin/schedules", icon: Calendar, roles: ["doktor", "sekreter", "hemsire"] },
...
export function AdminSidebar({ userRole }: { userRole: string | null }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "z-[55] h-screen w-64 flex-shrink-0 border-r border-gray-200 bg-white",

          // Desktop: sticky left sidebar
          "lg:sticky lg:top-0 lg:block",

          // Mobile: fixed positioning with slide animation
          "fixed left-0 top-0 transition-transform duration-300 lg:translate-x-0",
